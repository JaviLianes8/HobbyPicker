"""Language utilities for HobbyPicker."""
import locale
...
def get_effective_language(code: str | None) -> str:
    if code and code != "system":
        return code
    return get_system_language()


def tr(key: str, lang_code: str | None = None) -> str:
    """Translate a key using the given or effective language."""
