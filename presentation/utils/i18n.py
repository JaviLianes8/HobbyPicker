...
LANG_TEXT = {
    "es": {
        ...
        "edit_subitems_title": "Subelementos, Editar: {name}",
        ...
        "epic_login_title": "Conectar a Epic Games",
        "epic_token_prompt": "Se abrirá una página de Epic Games. Inicia sesión y copia el 'authorizationCode' que aparezca, luego pégalo aquí.",
        "epic_login_error": "No se pudo autenticar con Epic Games.",
        "btn_steam": "Steam",
        "btn_epic": "Epic Games",
        "btn_reset_counts": "Reiniciar contadores",
        "reset_counts_confirm": "¿Reiniciar todos los contadores?",
        "reset_counts_success": "Contadores reiniciados.",
    ...
    "en": {
        ...
        "edit_subitems_title": "Subitems, Edit: {name}",
        ...
        "epic_login_title": "Connect to Epic Games",
        "epic_token_prompt": "A browser window will open. Sign in and copy the 'authorizationCode' shown, then paste it here.",
        "epic_login_error": "Could not authenticate with Epic Games.",
        "btn_steam": "Steam",
        "btn_epic": "Epic Games",
        "btn_reset_counts": "Reset counters",
        "reset_counts_confirm": "Reset all counters?",
        "reset_counts_success": "Counters reset.",
