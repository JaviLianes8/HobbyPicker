...
LANG_TEXT = {
    "es": {
        ...
        "epic_token_prompt": "Se abrirá una página de Epic Games. Introduce el código {code} y autoriza la aplicación.",
    ...
    "en": {
        ...
        "epic_token_prompt": "A browser window will open. Enter code {code} and authorize the application.",
